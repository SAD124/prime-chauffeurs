...
const DownloadAppMini = () => {
  return (
    <section className="w-full bg-[#1E1E1E] border-t border-[#D4C5A0] 
      ...
      <div className="w-full max-w-[720px] mx-auto px-4 flex flex-col gap-15">
        ...
        <div className="flex flex-col gap-10 items-start">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-xl bg-[#D4C5A0] flex items-center justify-center">
              <Layers className="text-black w-5 h-5 sm:w-6 sm:h-6" />
            </div>

            <h2 className="text-[#D4C5A0] font-bold 
