...
const FAQMini = () => {
  ...
  return (
    <section className="block sm:hidden w-full bg-[#1E1E1E] border-t border-[#D4C5A0] py-10 px-3">
      <div className="flex flex-col gap-7">

        <h2 className="text-center text-[#D4C5A0] text-[26px] font-normal">
                ...
                className={`rounded-full px-3 py-1 text-[11px] transition-all
                  ${
                    isActive
                      ...
                      : "border border-[#FFFFFF4D] text-gray-300 hover:bg-[#3c4a56] hover:text-white"
                  }
                `}
              >
                {tab}
        ...
        <div className="flex flex-col">
          {filteredFAQs.map((item, idx) => (
            <div key={idx}>
              ...
              {openIndex === idx && (
                <p className="text-gray-400 text-[13px] pb-4">
                  {item.answer}
                </p>
              )}
